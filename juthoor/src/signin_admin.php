        ...
        if (isset($_POST["submit"])) {
            ...
            if ($valid) { 
                ...
                if ($result->num_rows > 0) { 
                    ...
                    {
                        setcookie("Juthoor_admin_username", $username, time() + (86400 * 30), "/");
                        setcookie("Juthoor_admin_password", $password, time() + (86400 * 30), "/");
                    }
...
<h3 class="head">Sign in Admin</h3>
...
<form action="signin_admin.php" method="post">
      ...
      <input type="text" placeholder="Enter Email" name="username" value="<?php if(isset($_COOKIE['Juthoor_admin_username'])) echo $_COOKIE['Juthoor_admin_username'];?>">
      <label class="error"><?php if(isset($errors['username'])) echo $errors['username'];?></label><br>

      <label for="psw"><b>Password</b></label>
      <input type="password" placeholder="Enter Password" name="password" value="<?php if(isset($_COOKIE['Juthoor_admin_password'])) echo $_COOKIE['Juthoor_admin_password'];?>">
