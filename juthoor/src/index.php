...
<meta name = "description" content = "This page should guide the search engines to the fact that its content incudes selling indoor plants and its accessories">
...
.img1 { position: absolute; top: 8%; margin-left: -700px; filter: invert(100%) sepia(0%) saturate(7500%) hue-rotate(336deg) brightness(104%) contrast(104%); }

.fig {position: absolute; top: 20%; color: white; text-align:center; margin-left: 655px;}
...
ul li a {display: block; text-align: center; color: white; transition: 0.5s; text-decoration: none; font-size: 15px; }
 ...
 ul li:hover {background-color: #2E8B57; border-color:#2E8B57; border-color: rgba(0, 0, 0, 0.40); transition:0.5s; }
...
.img50 { position: absolute; top: 15%; margin-left: -80px; filter: invert(100%) sepia(0%) saturate(7500%) hue-rotate(336deg) brightness(104%) contrast(104%); }
...
<div class="banner">
<div class="imgbox">
<img class="center-fit" src = "photo1.jpg"  >
</div>
<h1 class="heading"> Is There Such a Thing as <br> Too Many Plants?</h1>
<p class="p1"> Discover the latest addition to your growing plant collection</p>
<a href ="Plantpage1.php" > <button class="btn btn1">Shop Plants</button></a>
<figure>
...
<a href ="aaccount.php" ><i class='fa fa-user fa-2x  white-color fa-2xl' style="margin-left: 50px;"></i></a>
</div>
...
<a href ="Plantpage1.php" > <button class="bttn bntt ">Shop All</button></a>
    <div class="headi ">
 ...
 <h1><span>New</span> Arrivals</h1>  
    ...
    <?php 
    include 'config.php';     
     $results = $conn->query("SELECT *  FROM plants ORDER BY RAND ( ) LIMIT 8 ");
  ...
  if($c%4==0)
      ...
      echo ' <form action="index.php" method="post"><div class="ac">
        <div class="img-cover">
